...
export default function CreditCardTransfer() {
    ...
    return (
        ...
        >
            ...
            >
                <Typography variant="h6" sx={{ flexGrow: 1, ml:3, color:'primary.main'}}> CREDIT CARD TRANSFER </Typography>
                <Button
                    variant="contained"
                    color="primary"
                    startIcon={<ArrowBack />}
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider', width: '100%' }}>
                ...
                >
                    ...
                    <Tab label="My Other Account" {...a11yProps(1)} />
                </Tabs>
            </Box>
